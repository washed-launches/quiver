...
export default function QuiverTokenPage() {
  ...
  return (
    <div className="mx-auto grid max-w-page items-start gap-10 px-4 py-10 sm:px-5 sm:py-16 lg:grid-cols-[0.42fr_1fr]">
      <CurveGraphic tall caption="$QUIVER trades on PONS, not here" />
      <div className="max-w-xl lg:pt-2">
        <p className="eyebrow">On PONS</p>
        <h1 className="mt-4 font-display text-4xl text-forest sm:text-5xl">$QUIVER</h1>
        ...
        <a href={url} className="btn-primary mt-8 inline-flex w-full sm:w-auto" target="_blank" rel="noreferrer">
          Trade on PONS
        </a>
